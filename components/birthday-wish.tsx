      ...
      >
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">21st Birthday To Come!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-600">Farhan Yaseen</CardDescription>
            <p className="text-lg text-gray-500">January 6th</p>
          </CardHeader>
